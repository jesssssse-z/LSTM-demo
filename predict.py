...
#
# # 载入模型
model = load_model('model/model_%d_%d_%d.h5'%(grid_size,n_timestamp,pred_timestamp))
# model = load_model('model/model_%d_%d_%d_mask.h5'%(grid_size,n_timestamp,pred_timestamp))
